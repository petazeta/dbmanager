<template>
  ...
  <script>
	...
	},
	{
      ...
      if (thisNode.parentNode.properties.sort_order) {
	...
	admnlauncher.buttons.push({
      ...
      if (thisNode.parentNode.partnerNode && thisNode.parentNode.partnerNode.properties.id) {
	admnlauncher.buttons.push({
	  template: "templates/butdeletelink.php",
	  args:{thisNode: thisNode}
	},
	{
	  template: "templates/butaddnodelink.php",
	  args:{thisParent: thisNode.parentNode, thisNode: thisNode}
	},
	{
	  template: "templates/buteditlink.php",
	  args:{thisNode: thisNode}
	});
      }
